...
description: 中文学习实践共演助手。用于读书、读文章、课程笔记、摘录、PDF、EPUB、高亮集、NotebookLM 材料、主动回忆、费曼解释、理解批改、迁移练习、长期学习工作区、Learning Record、Learning Session Record，以及从导师批改切换到真实项目执行。不要把它当成通用总结器。
language: zh-CN
